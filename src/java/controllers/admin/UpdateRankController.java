 ...
 * @author nguyen
 */
@WebServlet(urlPatterns = {"/admin-update-rank"})
public class UpdateRankController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean check = this.userService.updateRankById(Long.valueOf(id), Long.valueOf(rankId));
        Timestamp date = new Timestamp(System.currentTimeMillis());
        Long checkHistory = this.historyService.saveHistory(Long.valueOf(id), date.toString(), "Modify");
