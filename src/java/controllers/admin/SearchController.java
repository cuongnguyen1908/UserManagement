...
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Long.valueOf(roleId) == 0) {
            //search all
            user.setListResult(this.userService.findAllByFullNameAndStatus(textSearch.toLowerCase(), true));
        } else {
            user.setListResult(this.userService.findAllByFullNameAndRoleAndStatus(textSearch.toLowerCase(), Long.valueOf(roleId), true));
